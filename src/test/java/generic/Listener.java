...
public class Listener extends BaseTest implements ITestListener{
	...
	{
		System.out.println("");
		System.out.println("LIS : " + result.getName() + " Test Case is started");
	}

	@Override
	public void onTestSuccess(ITestResult result) 
	{
		System.out.println("LIS : " + result.getName() + " Test Case is Success");
	...
	{
		System.out.println("LIS : " + result.getName() + " Test Case is Failed");
